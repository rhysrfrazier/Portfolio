        ...
        <div className='footer'>
            <div className="socials">
                <a href='https://github.com/rhysrfrazier' target='_blank'>
                    <i className="fa-brands fa-github fa-3x" aria-hidden='true'>
                        <span className='fa-sr-only'>Rhys' Github Link</span>
                    </i>
                </a>
                <a href='https://www.linkedin.com/in/rhysrfrazier/' target='_blank'>
                    <i className="fa-brands fa-linkedin-in fa-3x" aria-hidden='true'>
                ...
                <div className='tooltip'>
                    ...
                    className='resumeLink'>
                        <img src='resume.svg' alt='resume' className='resume' />
                    </a>
